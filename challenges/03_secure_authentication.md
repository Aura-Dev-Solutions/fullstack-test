...
**Note:** If you plan to implement [Challenge 6](./06_user_role_management.md) (User Role Management), include a `role` field in the JWT payload from the start. This avoids having to modify the token structure later.
