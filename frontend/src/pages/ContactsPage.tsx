...
export function ContactsPage() {
  ...
  async function loadContacts() {
    // TODO [Challenge 5]: Add pagination parameters (page, limit) to this request and handle PaginatedResult response
    try {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    setSaving(true)
    // TODO [Challenge 4]: Add form validation here before submitting
